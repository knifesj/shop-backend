package com.example.dachuang.generator;
...
public class MybatisCodeGenerator {
    ...
    private static final String schemaName = "dachuang";   // 数据库名称，必填
    private static final String[] table = {"t_user", "User"};   // 必填，第一个是表名，第二个是实体类的名字
    ...
    private static final String BaseFilePath = System.getProperty("user.dir") + "/src/main/java/com/example/dachuang";
